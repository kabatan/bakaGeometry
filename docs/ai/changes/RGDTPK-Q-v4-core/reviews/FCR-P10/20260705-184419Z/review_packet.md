...
- `FULL_CORE_REPAIR_PLAN.md` FCR-P10 requires A1-A13 acceptance categories through public or near-public pipeline.
...
- Added public `api::solve_target` FCR-P10 suite covering A1-A13.
...
- `cargo test --manifest-path geosolver-core/Cargo.toml --test fcr_p10_acceptance_suite fcr_p10_a13_public_resource_bounded_hard_case_has_spec_status -- --nocapture`: PASS, 1/1
...
- FCR-P12 red-team remains required before any generic readiness claim.
