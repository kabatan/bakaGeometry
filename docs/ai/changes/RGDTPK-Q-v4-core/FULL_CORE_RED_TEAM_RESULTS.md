...
| one-large-block no-separator | `fcr_p11_red_team_05_one_large_block_universal_path` | public `api::solve_target`, `UniversalTargetElimination` prioritized | `CertifiedCandidateCover` | no relation-search shortcut; replay accepted |
